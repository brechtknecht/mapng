  ...
  <div class="space-y-4">
    ...
    <BaseCard v-if="hasRoute">
      ...
      <template v-if="baking">
        <div class="text-[12px] text-gray-700 dark:text-gray-200 mb-2">
          {{ t('route.bakeProgress', {
            chunk: Math.min((bakeProgress?.chunk ?? 0) + 1, chunkCount),
            total: chunkCount,
...
import { CORRIDOR_TIERS } from '../../services/routeCorridor';
...
const props = defineProps({
  ...
  bakeProgress: { type: Object, default: null }, // { chunk, total, phase, detail }
});
