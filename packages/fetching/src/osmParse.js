/** @layer core */
// Pure Overpass parsing: the query builder + the response → mapng-feature
// converter (way/relation assembly, area detection, ring joining, bbox clip,
// procedural tree seeding). No network, no state — pure / DOM-free. Extracted
// from osm.js (docs/refactor/06 step 5); osm.js imports buildQuery +
...
export const parseOverpassResponse = (data, bounds) => {
  const ways = {};
  const relations = [];
  const rawFeatures = [];
