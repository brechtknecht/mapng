/** @layer io */
// NMT EVRF2007 (KRON86) elevation fetch: WFS tile-index query, download with
// proxy redirects, ZIP/ASC/point-grid extraction. The pure URL/XML/header
// helpers live in kron86Parse.js (docs/refactor/06 step 5).

import JSZip from 'jszip';
import { isLikelyAscText, parseAscText, applyAscCoordinateSystem } from './ascLoader.js';
import {
  KRON86_DEFAULT_YEAR,
  KRON86_POLAND_BOUNDS,
  isWithinKron86Coverage,
  logInfo,
  logWarn,
  logAscHeaderDiagnostics,
  extractAscHeaderFields,
  toPseudoAscMeta,
  hasZipSignature,
  decodeBufferToText,
  buildYearCandidates,
  ...
  buildGetFeatureUrl,
  toProxyPath,
  extractAvailableYearsFromCapabilities,
  parseNumberReturned,
  extractLinkCandidatesFromFeatureXml,
} from './kron86Parse.js';

// Public coverage API stays importable from @mapng/fetching/kron86 unchanged.
export { KRON86_POLAND_BOUNDS, isWithinKron86Coverage };
